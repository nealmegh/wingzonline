...
! function(t) {
    ...
    var r, o, i, n, s, l, u, a, h, c, p, d, f, g, y, v, m, w, R, S, b, C, E, T, H, _, I, D, x, F, G, M, W, L, B, k, z, V, P, A, O, N, q, Y, j, U, X, $, K, Q, J, Z, tt, et, rt, ot, it, nt, st, lt, ut, at, ht, ct, pt, dt, ft, gt, yt, vt, mt, wt, Rt, St, bt, Ct, Et, Tt, Ht, _t, It, Dt, xt, Ft, Gt, Mt, Wt, Lt, Bt, kt, zt = function(t, e) {
            function r() {
                this.constructor = t
            }
    ...
    return d = t.fullCalendar, d.schedulerVersion = "1.3.0", 3 !== d.internalApiVersion ? void d.warn("v" + d.schedulerVersion + " of FullCalendar Scheduler is incompatible with v" + d.version + " of the core.\nPlease see http://fullcalendar.io/support/ for more information.") : (o = d.Calendar, n = d.Class, X = d.View, f = d.Grid, vt = d.intersectRanges, ot = d.debounce, Rt = d.isInt, ft = d.getScrollbarWidths, a = d.DragListener, yt = d.htmlEscape, J = d.computeIntervalUnit, Ft = d.proxy, K = d.capitaliseFirstLetter, $ = d.applyAll, h = d.EmitterMixin, v = d.ListenerMixin, lt = d.durationHasTime, st = d.divideRangeByDuration, nt = d.divideDurationByDuration, Ct = d.multiplyDuration, Dt = d.parseFieldSpecs, Q = d.compareByFieldSpecs, ut = d.flexibleCompare, mt = d.intersectRects, l = d.CoordCache, at = d.getContentRect, ht = d.getOuterRect, ct = function(t) {
        ...
        return zt(r, e), r.mixin(h), r.mixin(v), r.prototype.canvas = null, r.prototype.isScrolling = !1, r.prototype.isTouching = !1, r.prototype.isMoving = !1, r.prototype.isTouchScrollEnabled = !0, r.prototype.preventTouchScrollHandler = null, r.prototype.render = function() {
            ...
            return this.preventTouchScrollHandler ? void 0 : this.scrollEl.on("touchmove", this.preventTouchScrollHandler = d.preventDefault)
            ...
            var t, e, r;
            if (t = this.scrollEl.css("direction"), e = this.scrollEl[0], r = e.scrollLeft, "rtl" === t) switch (i) {
                case "positive":
            ...
            return r
        }, r.prototype.setScrollLeft = function(t) {
            var e, r;
            if (e = this.scrollEl.css("direction"), r = this.scrollEl[0], "rtl" === e) switch (i) {
                case "positive":
                    t = t - r.clientWidth + r.scrollWidth;
                    break;
                case "reverse":
                    t = -t
            }
        ...
        }, r.prototype.setNativeScrollLeft = function(t) {
            return this.scrollEl[0].scrollLeft = t
        }, i = null, o = function() {
            var e, r, o;
        ...
        return zt(r, e), r.prototype.isHScrollbarsClipped = !1, r.prototype.isVScrollbarsClipped = !1, r.prototype.renderEl = function() {
            var e;
            return e = r.__super__.renderEl.apply(this, arguments), t('<div class="fc-scroller-clip" />').append(e)
        }, r.prototype.updateSize = function() {
            var t, e, r;
            return e = this.scrollEl, r = ft(e), t = {
                marginLeft: 0,
                marginRight: 0,
                marginTop: 0,
                marginBottom: 0
            }, this.isHScrollbarsClipped && (t.marginTop = -r.top, t.marginBottom = -r.bottom), this.isVScrollbarsClipped && (t.marginLeft = -r.left, t.marginRight = -r.right), e.css(t), e.toggleClass("fc-no-scrollbars", (this.isHScrollbarsClipped || "hidden" === this.overflowX) && (this.isVScrollbarsClipped || "hidden" === this.overflowY) && !(r.top || r.bottom || r.left || r.right))
        }, r.prototype.getScrollbarWidths = function() {
            var t;
            return t = ft(this.scrollEl), this.isHScrollbarsClipped && (t.top = 0, t.bottom = 0), this.isVScrollbarsClipped && (t.left = 0, t.right = 0), t
        }, r
    }(c), O = function() {
        function e() {
            this.gutters = {}
        }
        return e.prototype.el = null, e.prototype.contentEl = null, e.prototype.bgEl = null, e.prototype.gutters = null, e.prototype.width = null, e.prototype.minWidth = null, e.prototype.render = function() {
            return this.el = t('<div class="fc-scroller-canvas"> <div class="fc-content"></div> <div class="fc-bg"></div> </div>'), this.contentEl = this.el.find(".fc-content"), this.bgEl = this.el.find(".fc-bg")
        }, e.prototype.setGutters = function(e) {
            return e ? t.extend(this.gutters, e) : this.gutters = {}, this.updateSize()
        }, e.prototype.setWidth = function(t) {
            return this.width = t, this.updateSize()
        }, e.prototype.setMinWidth = function(t) {
            return this.minWidth = t, this.updateSize()
        }, e.prototype.clearWidth = function() {
            return this.width = null, this.minWidth = null, this.updateSize()
        }, e.prototype.updateSize = function() {
            var t;
            return t = this.gutters, this.el.toggleClass("fc-gutter-left", Boolean(t.left)).toggleClass("fc-gutter-right", Boolean(t.right)).toggleClass("fc-gutter-top", Boolean(t.top)).toggleClass("fc-gutter-bottom", Boolean(t.bottom)).css({
                paddingLeft: t.left || "",
                paddingRight: t.right || "",
                paddingTop: t.top || "",
                paddingBottom: t.bottom || "",
                width: null != this.width ? this.width + (t.left || 0) + (t.right || 0) : "",
                minWidth: null != this.minWidth ? this.minWidth + (t.left || 0) + (t.right || 0) : ""
            }), this.bgEl.css({
                left: t.left || "",
                right: t.right || "",
                top: t.top || "",
        ...
        function t(t, e) {
            var r, o, i, n;
            for (this.axis = t, this.scrollers = e, i = this.scrollers, r = 0, o = i.length; o > r; r++) n = i[r], this.initScroller(n)
        }
        return t.prototype.axis = null, t.prototype.scrollers = null, t.prototype.masterScroller = null, t.prototype.initScroller = function(t) {
            return t.scrollEl.on("wheel mousewheel DomMouseScroll MozMousePixelScroll", function(e) {
                return function() {
                    e.assignMasterScroller(t)
                }
            }(this)), t.on("scrollStart", function(e) {
                return function() {
                    return e.masterScroller ? void 0 : e.assignMasterScroller(t)
                }
            }(this)).on("scroll", function(e) {
                return function() {
                    var r, o, i, n, s;
                    if (t === e.masterScroller) {
                        for (n = e.scrollers, s = [], r = 0, o = n.length; o > r; r++)
                            if (i = n[r], i !== t) switch (e.axis) {
                                case "horizontal":
                                    s.push(i.setNativeScrollLeft(t.getNativeScrollLeft()));
                                    break;
                                case "vertical":
                                    s.push(i.setScrollTop(t.getScrollTop()));
                                    break;
                                default:
                                    s.push(void 0)
                            } else s.push(void 0);
                ...
                return function() {
                    return t === e.masterScroller ? e.unassignMasterScroller() : void 0
                }
            }(this))
        }, t.prototype.assignMasterScroller = function(t) {
            var e, r, o, i;
            for (this.unassignMasterScroller(), this.masterScroller = t, i = this.scrollers, e = 0, r = i.length; r > e; e++) o = i[e], o !== t && o.disableTouchScroll()
        }, t.prototype.unassignMasterScroller = function() {
            var t, e, r, o;
            if (this.masterScroller) {
                for (o = this.scrollers, t = 0, e = o.length; e > t; t++) r = o[t], r.enableTouchScroll();
                this.masterScroller = null
            }
        }, t.prototype.update = function() {
            var t, e, r, o, i, n, s, l, u, a, h, c, p;
            for (t = function() {
                var t, e, r, o;
                for (r = this.scrollers, o = [], t = 0, e = r.length; e > t; t++) c = r[t], o.push(c.getScrollbarWidths());
                return o
            }.call(this), l = u = a = s = 0, r = 0, i = t.length; i > r; r++) p = t[r], l = Math.max(l, p.left), u = Math.max(u, p.right), a = Math.max(a, p.top), s = Math.max(s, p.bottom);
            for (h = this.scrollers, e = o = 0, n = h.length; n > o; e = ++o) c = h[e], p = t[e], c.canvas.setGutters("horizontal" === this.axis ? {
                left: l - p.left,
                right: u - p.right
            } : {
                top: a - p.top,
        ...
        function e(t, e) {
            this.isTouch = e, this.scroller = t, this.sprites = [], this.isTouch && (this.isForcedRelative = !0), t.on(this.isTouch ? "scrollEnd" : "scroll", function(t) {
                return function() {
                    return t.handleScroll()
                }
            }(this))
        }
        return e.prototype.scroller = null, e.prototype.scrollbarWidths = null, e.prototype.sprites = null, e.prototype.viewportRect = null, e.prototype.contentOffset = null, e.prototype.isHFollowing = !0, e.prototype.isVFollowing = !1, e.prototype.containOnNaturalLeft = !1, e.prototype.containOnNaturalRight = !1, e.prototype.minTravel = 0, e.prototype.isTouch = !1, e.prototype.isForcedRelative = !1, e.prototype.setSprites = function(e) {
            var r, o, i;
            if (this.clearSprites(), e instanceof t) return this.sprites = function() {
                var r, o, n;
                for (n = [], r = 0, o = e.length; o > r; r++) i = e[r], n.push(new P(t(i), this));
                return n
            }.call(this);
            for (r = 0, o = e.length; o > r; r++) i = e[r], i.follower = this;
            ...
            var t, e, r, o;
            for (this.updateViewport(), this.scrollbarWidths = this.scroller.getScrollbarWidths(), this.contentOffset = this.scroller.canvas.el.offset(), r = this.sprites, t = 0, e = r.length; e > t; t++) o = r[t], o.cacheDimensions()
        }, e.prototype.updateViewport = function() {
            var t, e, r;
            return e = this.scroller, t = e.getScrollFromLeft(), r = e.getScrollTop(), this.viewportRect = {
                left: t,
            ...
            if (!this.isForcedRelative) {
                for (this.isForcedRelative = !0, r = this.sprites, o = [], t = 0, e = r.length; e > t; t++) i = r[t], o.push(i.doAbsolute ? i.assignPosition() : void 0);
                return o
            }
        }, e.prototype.clearForce = function() {
            var t, e, r, o, i;
            if (this.isForcedRelative && !this.isTouch) {
                for (this.isForcedRelative = !1, r = this.sprites, o = [], t = 0, e = r.length; e > t; t++) i = r[t], o.push(i.assignPosition());
                return o
            }
            ...
            return at(t, this.contentOffset)
        }, e.prototype.getBoundingRect = function(t) {
            return ht(t, this.contentOffset)
        }, e
    }(), P = function() {
        function t(t, e) {
        ...
        return t.prototype.follower = null, t.prototype.el = null, t.prototype.absoluteEl = null, t.prototype.naturalRect = null, t.prototype.parentRect = null, t.prototype.containerRect = null, t.prototype.isEnabled = !0, t.prototype.isHFollowing = !1, t.prototype.isVFollowing = !1, t.prototype.doAbsolute = !1, t.prototype.isAbsolute = !1, t.prototype.isCentered = !1, t.prototype.rect = null, t.prototype.isBlock = !1, t.prototype.naturalWidth = null, t.prototype.disable = function() {
            ...
            var t, e, r, o, i, n, s, l;
            return s = this.follower.viewportRect, r = this.parentRect, t = this.containerRect, l = mt(s, r), o = null, e = !1, l && (o = et(this.naturalRect), n = mt(o, r), (this.isCentered && !Mt(s, r) || n && !Mt(s, n)) && (e = !0, this.isHFollowing && (this.isCentered ? (i = dt(o), o.left = (l.left + l.right) / 2 - i / 2, o.right = o.left + i) : gt(o, s) || (e = !1), gt(o, t) && (e = !1)), this.isVFollowing && (kt(o, s) || (e = !1), kt(o, t) && (e = !1)), Mt(s, o) || (e = !1))), this.rect = o, this.doAbsolute = e
            ...
            })) : (e = this.rect.top - this.naturalRect.top, t = this.rect.left - this.naturalRect.left, this.unabsolutize(), this.el.toggleClass("fc-following", Boolean(e || t)).css({
                top: e,
                left: t
        ...
        return Wt(t, e) && Lt(t, e)
    }, Wt = function(t, e) {
        return e.left >= t.left && e.right <= t.right
    }, Lt = function(t, e) {
        return e.top >= t.top && e.bottom <= t.bottom
    }, gt = function(t, e) {
        return t.left < e.left ? (t.right = e.left + dt(t), t.left = e.left, !0) : t.right > e.right ? (t.left = e.right - dt(t), t.right = e.right, !0) : !1
    }, kt = function(t, e) {
        return t.top < e.top ? (t.bottom = e.top + pt(t), t.top = e.top, !0) : t.bottom > e.bottom ? (t.top = e.bottom - pt(t), t.bottom = e.bottom, !0) : !1
    }, bt = function(t, e) {
        return {
        ...
        return zt(r, e), r.prototype.resourceManager = null, r.prototype.initialize = function() {
            return this.resourceManager = new D(this)
            ...
            var o, i, n, s, l, u, a, h, c, p, d, f, g, y;
            for (f = r.__super__.getPeerEvents.apply(this, arguments), p = t.resourceId ? [t.resourceId] : e ? this.getEventResourceIds(e) : [], o = [], n = 0, u = f.length; u > n; n++) {
                if (d = f[n], i = !1, y = this.getEventResourceIds(d), y.length && p.length) {
                    for (s = 0, a = y.length; a > s; s++)
                        for (g = y[s], l = 0, h = p.length; h > l; l++)
                            if (c = p[l], c === g) {
                                i = !0;
                                break
                            }
            ...
            var i;
            return i = r.__super__.buildSelectSpan.apply(this, arguments), o && (i.resourceId = o), i
            ...
            var e, r, o, i, n, s, l, u;
            if (u = String(null != (n = null != (s = t[this.getEventResourceField()]) ? s : t.resourceId) ? n : "")) return [u];
            if (t.resourceIds) {
                for (i = [], l = t.resourceIds, e = 0, r = l.length; r > e; e++) u = l[e], o = String(null != u ? u : ""), o && i.push(o);
                return i
            }
            return []
            ...
            var e, r, o, i, n, s, l;
            if (e = "object" == typeof t ? t : this.clientEvents(t)[0], l = [], e)
                for (i = this.getEventResourceIds(e), r = 0, o = i.length; o > r; r++) s = i[r], n = this.getResourceById(s), n && l.push(n);
            return l
        }, r
    }(o), o.prototype = i.prototype, Tt = X.prototype.displayView, _t = X.prototype.renderSkeleton, It = X.prototype.unrenderSkeleton, Et = X.prototype.displayEvents, X.prototype.isResourcesBound = !1, X.prototype.settingResources = null, X.prototype.displayView = function() {
        return Tt.apply(this, arguments), xt(this.calendar.options.schedulerLicenseKey, this.el), this.bindResources(), this.whenResources()
    }, X.prototype.unrenderSkeleton = function() {
        return It.apply(this, arguments), this.unbindResources()
    }, X.prototype.displayEvents = function(t) {
        return this.whenResources(function(e) {
            return function() {
                return Et.call(e, t)
            }
        }(this))
    }, X.prototype.bindResources = function() {
        var e;
        ...
        }(this), this.listenTo(this.calendar.resourceManager, {
            set: e,
            unset: this.unsetResources,
            reset: this.resetResources,
            add: this.addResource,
            remove: this.removeResource
        }), this.calendar.resourceManager.hasFetched() ? e(this.calendar.resourceManager.topLevelResources) : this.calendar.resourceManager.getResources())
    }, X.prototype.unbindResources = function() {
        return this.isResourcesBound ? (this.stopListeningTo(this.calendar.resourceManager), "resolved" === this.settingResources.state() && this.unsetResources(), this.settingResources = null, this.isResourcesBound = !1) : void 0
    }, X.prototype.whenResources = function(e) {
    ...
    }, X.prototype.setResources = function(t) {}, X.prototype.unsetResources = function() {}, X.prototype.resetResources = function(t) {
        return this.calendar.rerenderEvents()
    }, X.prototype.addResource = function(t) {
        return this.resetResources(this.calendar.resourceManager.topLevelResources)
    }, X.prototype.removeResource = function(t) {
        return this.resetResources(this.calendar.resourceManager.topLevelResources)
    }, Ht = f.prototype.getSegClasses, f.prototype.getSegClasses = function(t) {
        var e, r, o, i, n;
        for (e = Ht.apply(this, arguments), i = this.getSegResources(t), r = 0, o = i.length; o > r; r++) n = i[r], e = e.concat(n.eventClassName || []);
        return e
    }, f.prototype.getSegSkinCss = function(t) {
        var e, r, o, i, n, s, l, u, a, h;
        return h = this.view, e = t.event, u = e.source || {}, r = e.color, a = u.color, s = h.opt("eventColor"), l = this.getSegResources(t), o = function() {
            var t, e, r, o;
            for (o = null, e = 0, r = l.length; r > e; e++)
                for (t = l[e]; t && !o;) o = t.eventBackgroundColor || t.eventColor, t = t._parent;
            return o
        }, i = function() {
            var t, e, r, o;
            for (o = null, e = 0, r = l.length; r > e; e++)
                for (t = l[e]; t && !o;) o = t.eventBorderColor || t.eventColor, t = t._parent;
            return o
        }, n = function() {
            var t, e, r, o;
            for (o = null, e = 0, r = l.length; r > e; e++)
                for (t = l[e]; t && !o;) o = t.eventTextColor, t = t._parent;
            return o
        }, {
            "background-color": e.backgroundColor || r || o() || u.backgroundColor || a || h.opt("eventBackgroundColor") || s,
            "border-color": e.borderColor || r || i() || u.borderColor || a || h.opt("eventBorderColor") || s,
            color: e.textColor || n() || u.textColor || h.opt("eventTextColor")
        }
    }, f.prototype.getSegResources = function(t) {
        return t.resource ? [t.resource] : this.view.calendar.getEventResources(t.event)
    }, D = function(e) {
        function r(t) {
            this.calendar = t, this.initializeCache()
        }
        return zt(r, e), r.mixin(h), r.resourceGuid = 1, r.ajaxDefaults = {
            dataType: "json",
            cache: !1
            ...
            var e, o, i;
            switch (e = t.Deferred(), i = this.calendar.options.resources, "string" === t.type(i) && (i = {
                url: i
            }), t.type(i)) {
                case "function":
                    i(function(t) {
                    ...
                    break;
                case "object":
                    o = t.ajax(t.extend({}, r.ajaxDefaults, i));
                    break;
                case "array":
                    e.resolve(i);
                    break;
            ...
            for (this.initializeCache(), s = function() {
                ...
                var t, e, r;
                for (r = [], t = 0, e = s.length; e > t; t++) i = s[t], this.addResourceToIndex(i) && r.push(i);
                return r
            }.call(this), r = 0, o = l.length; o > r; r++) i = l[r], this.addResourceToTree(i);
            ...
            for (this.resourcesById[t.id] = t, i = t.children, r = 0, o = i.length; o > r; r++) e = i[r], this.addResourceToIndex(e);
            return !0
            ...
            if (!t.parent) {
                if (r = String(null != (o = t.parentId) ? o : "")) {
                    ...
                    t.parent = e, i = e.children
                } else i = this.topLevelResources;
                i.push(t)
            }
            return !0
            ...
            var e, r, o, i, n;
            if (n = this.resourcesById[t]) {
                for (delete this.resourcesById[t], i = n.children, r = 0, o = i.length; o > r; r++) e = i[r], this.removeResourceFromIndex(e.id);
                return n
            }
            return !1
        }, r.prototype.removeResourceFromTree = function(t, e) {
            var r, o, i, n;
            for (null == e && (e = this.topLevelResources), r = o = 0, i = e.length; i > o; r = ++o) {
                if (n = e[r], n === t) return t.parent = null, e.splice(r, 1), !0;
                if (this.removeResourceFromTree(t, n.children)) return !0
            }
            return !1
        }, r.prototype.buildResource = function(e) {
            var o, i, n, s, l;
            return l = t.extend({}, e), l.id = String(null != (s = e.id) ? s : "_fc" + r.resourceGuid++), n = e.eventClassName, l.eventClassName = function() {
                switch (t.type(n)) {
                    case "string":
                        return n.split(/\s+/);
                    case "array":
                ...
                var t, r, n, s, u;
                for (s = null != (n = e.children) ? n : [], u = [], t = 0, r = s.length; r > t; t++) i = s[t], o = this.buildResource(i), o.parent = l, u.push(o);
                return u
            }.call(this), l
        }, r
    }(n), L = {
        ...
        triggerDayClick: function(t, e, r) {
            var o;
        ...
        triggerExternalDrop: function(t, e, r, o, i) {
            return this.trigger("drop", r[0], e.start, o, i, e.resourceId), t ? this.trigger("eventReceive", null, t) : void 0
        },
        reportEventDrop: function() {
            var t, e, r, o;
            return e = arguments[0], t = arguments[1], r = 3 <= arguments.length ? Pt.call(arguments, 2) : [], t = this.normalizeDropLocation(t), t.resourceId && e.resourceIds && (t.resourceIds = null), (o = X.prototype.reportEventDrop).call.apply(o, [this, e, t].concat(Pt.call(r)))
        },
        reportExternalDrop: function() {
            var t, e, r, o;
            return e = arguments[0], t = arguments[1], r = 3 <= arguments.length ? Pt.call(arguments, 2) : [], t = this.normalizeDropLocation(t), (o = X.prototype.reportExternalDrop).call.apply(o, [this, e, t].concat(Pt.call(r)))
        },
        normalizeDropLocation: function(e) {
            var r;
            return r = t.extend({}, e), delete r.resourceId, this.calendar.setEventResourceId(r, e.resourceId), r
        }
    }, I = {
        allowCrossResource: !0,
        eventRangeToSpans: function(e, r) {
            var o, i, n, s, l;
            if (s = this.view.calendar.getEventResourceIds(r), s.length) {
                for (l = [], o = 0, i = s.length; i > o; o++) n = s[o], l.push(t.extend({}, e, {
                    resourceId: n
                }));
                return l
            }
        ...
        fabricateHelperEvent: function(t, e) {
            var r;
            return r = f.prototype.fabricateHelperEvent.apply(this, arguments), this.view.calendar.setEventResourceId(r, t.resourceId), r
        },
        computeEventDrop: function(t, e, r) {
            var o, i;
            return o = !0, o || t.resourceId === e.resourceId ? (i = f.prototype.computeEventDrop.apply(this, arguments), i && (i.resourceId = e.resourceId), i) : null
        },
        computeExternalDrop: function(t, e) {
            var r;
            return r = f.prototype.computeExternalDrop.apply(this, arguments), r && (r.resourceId = t.resourceId), r
        },
        computeEventResize: function(t, e, r, o) {
            var i;
            if (this.allowCrossResource || e.resourceId === r.resourceId) return i = f.prototype.computeEventResize.apply(this, arguments), i && (i.resourceId = e.resourceId), i
        },
        computeSelectionSpan: function(t, e) {
            var r;
            if (this.allowCrossResource || t.resourceId === e.resourceId) return r = f.prototype.computeSelectionSpan.apply(this, arguments), r && (r.resourceId = t.resourceId), r
        }
    }, _ = {
        ...
        flattenResources: function(t) {
            var e, r, o, i;
            return r = this.view.opt("resourceOrder"), r ? (e = Dt(r), i = function(t, r) {
                return Q(t, r, e)
            }) : i = null, o = [], this.accumulateResources(t, i, o), o
        },
        accumulateResources: function(t, e, r) {
            var o, i, n, s, l;
            for (e ? (l = t.slice(0), l.sort(e)) : l = t, s = [], o = 0, i = l.length; i > o; o++) n = l[o], r.push(n), s.push(this.accumulateResources(n.children, e, r));
            return s
        },
        ...
        renderHeadResourceHtml: function() {
            var t, e, r, o, i;
            for (i = [], r = this.flattenedResources, t = 0, e = r.length; e > t; t++) o = r[t], i.push(this.renderHeadResourceCellHtml(o));
            return this.wrapTr(i, "renderHeadIntroHtml")
        },
        renderHeadResourceAndDateHtml: function() {
            var t, e, r, o, i, n, s, l, u, a;
            for (a = [], e = [], s = this.flattenedResources, o = 0, n = s.length; n > o; o++)
                for (u = s[o], a.push(this.renderHeadResourceCellHtml(u, null, this.daysPerRow)), r = i = 0, l = this.daysPerRow; l > i; r = i += 1) t = this.dayDates[r].clone(), e.push(this.renderHeadResourceDateCellHtml(t, u));
            return this.wrapTr(a, "renderHeadIntroHtml") + this.wrapTr(e, "renderHeadIntroHtml")
        },
        renderHeadDateAndResourceHtml: function() {
            var t, e, r, o, i, n, s, l, u, a;
            for (e = [], a = [], r = o = 0, s = this.daysPerRow; s > o; r = o += 1)
                for (t = this.dayDates[r].clone(), e.push(this.renderHeadDateCellHtml(t, this.resourceCnt)), l = this.flattenedResources, i = 0, n = l.length; n > i; i++) u = l[i], a.push(this.renderHeadResourceCellHtml(u, t));
            return this.wrapTr(e, "renderHeadIntroHtml") + this.wrapTr(a, "renderHeadIntroHtml")
        },
        renderHeadResourceCellHtml: function(t, e, r) {
            return '<th class="fc-resource-cell" data-resource-id="' + t.id + '"' + (e ? ' data-date="' + e.format("YYYY-MM-DD") + '"' : "") + (r > 1 ? ' colspan="' + r + '"' : "") + ">" + yt(this.view.getResourceText(t)) + "</th>"
        },
        ...
        processHeadResourceEls: function(e) {
            return e.find(".fc-resource-cell").each(function(e) {
                return function(r, o) {
                    var i;
                    return i = e.datesAboveResources ? e.getColResource(r) : e.flattenedResources[e.isRTL ? e.flattenedResources.length - 1 - r : r], e.view.trigger("resourceRender", i, i, t(o), t())
                }
            }(this))
        },
        renderBgCellsHtml: function(t) {
            var e, r, o, i, n, s;
            if (this.resourceCnt) {
                for (o = [], e = i = 0, n = this.colCnt; n > i; e = i += 1) r = this.getCellDate(t, e), s = this.getColResource(e), o.push(this.renderResourceBgCellHtml(r, s));
                return o.join("")
            }
            return d.DayTableMixin.renderBgCellsHtml.call(this, t)
        },
        ...
        return zt(r, e), r.mixin(I), r.mixin(_), r.prototype.getHitSpan = function(t) {
            var e;
            ...
            var r, o, i, n, s, l, u, a, h, c, p, d, f;
            if (h = this.resourceCnt, o = this.datesAboveResources ? this.sliceRangeByDay(e) : this.sliceRangeByRow(e), h) {
                for (d = [], n = 0, u = o.length; u > n; n++)
                    for (f = o[n], c = s = 0, a = h; a > s; c = s += 1) p = this.flattenedResources[c], e.resourceId && e.resourceId !== p.id || (r = t.extend({}, f), r.resource = p, this.isRTL ? (r.leftCol = this.indicesToCol(c, f.lastRowDayIndex), r.rightCol = this.indicesToCol(c, f.firstRowDayIndex)) : (r.leftCol = this.indicesToCol(c, f.firstRowDayIndex), r.rightCol = this.indicesToCol(c, f.lastRowDayIndex)), d.push(r));
                return d
            }
            for (i = 0, l = o.length; l > i; i++) f = o[i], this.isRTL ? (f.leftCol = f.lastRowDayIndex, f.rightCol = f.firstRowDayIndex) : (f.leftCol = f.firstRowDayIndex, f.rightCol = f.lastRowDayIndex);
            return o
        }, r
    }(d.DayGrid), G = function(e) {
        function r() {
            return r.__super__.constructor.apply(this, arguments)
        }
        return zt(r, e), r.mixin(I), r.mixin(_), r.prototype.getHitSpan = function(t) {
            ...
            var r, o, i, n, s, l, u, a, h, c, p, d, f;
            if (h = this.resourceCnt, o = this.sliceRangeByTimes(e), h) {
                for (d = [], n = 0, u = o.length; u > n; n++)
                    for (f = o[n], c = s = 0, a = h; a > s; c = s += 1) p = this.flattenedResources[c], e.resourceId && e.resourceId !== p.id || (r = t.extend({}, f), r.resource = p, r.col = this.indicesToCol(c, f.dayIndex), d.push(r));
                return d
            }
            for (i = 0, l = o.length; l > i; i++) f = o[i], f.col = f.dayIndex;
            return o
        }, r
    }(d.TimeGrid), Y = function(t) {
        function e() {
            return e.__super__.constructor.apply(this, arguments)
        }
        return zt(e, t), e.prototype.timeGrid = null, e.prototype.isScrolled = !1, e.prototype.initialize = function() {
            ...
            return this.timeGrid.setElement(this.el.find("tbody .fc-time-area")), this.timeGrid.headEl = this.el.find("thead .fc-time-area"), this.timeGrid.renderSkeleton(), this.isScrolled = !1, this.timeGrid.bodyScroller.on("scroll", Ft(this, "handleBodyScroll"))
    ...
    }(X), rt = d.cssToStr, q = function(r) {
        function o() {
            var t;
            o.__super__.constructor.apply(this, arguments), this.initScaleProps(), this.minTime = e.duration(this.opt("minTime") || "00:00"), this.maxTime = e.duration(this.opt("maxTime") || "24:00"), this.timeWindowMs = this.maxTime - this.minTime, this.snapDuration = (t = this.opt("snapDuration")) ? e.duration(t) : this.slotDuration, this.minResizeDuration = this.snapDuration, this.snapsPerSlot = nt(this.slotDuration, this.snapDuration), this.slotWidth = this.opt("slotWidth")
        }
        return zt(o, r), o.prototype.slotDates = null, o.prototype.slotCnt = null, o.prototype.snapCnt = null, o.prototype.snapsPerSlot = null, o.prototype.snapDiffToIndex = null, o.prototype.snapIndexToDiff = null, o.prototype.headEl = null, o.prototype.slatContainerEl = null, o.prototype.slatEls = null, o.prototype.containerCoordCache = null, o.prototype.slatCoordCache = null, o.prototype.slatInnerCoordCache = null, o.prototype.headScroller = null, o.prototype.bodyScroller = null, o.prototype.joiner = null, o.prototype.follower = null, o.prototype.eventTitleFollower = null, o.prototype.minTime = null, o.prototype.maxTime = null, o.prototype.timeWindowMs = null, o.prototype.slotDuration = null, o.prototype.snapDuration = null, o.prototype.duration = null, o.prototype.labelInterval = null, o.prototype.headerFormats = null, o.prototype.isTimeScale = null, o.prototype.largeUnit = null, o.prototype.emphasizeWeeks = !1, o.prototype.titleFollower = null, o.prototype.segContainerEl = null, o.prototype.segContainerHeight = null, o.prototype.bgSegContainerEl = null, o.prototype.helperEls = null, o.prototype.innerEl = null, o.prototype.opt = function(t) {
            ...
            var t, e, r, o, i;
            for (o = -1, e = 0, r = [], i = [], t = this.start.clone(); t < this.end;) this.isValidDate(t) ? (o++, r.push(o), i.push(e)) : r.push(o + .5), t.add(this.snapDuration), e++;
            return this.snapDiffToIndex = r, this.snapIndexToDiff = i, this.snapCnt = o + 1, this.slotCnt = this.snapCnt / this.snapsPerSlot
        }, o.prototype.spanToSegs = function(t) {
            var e, r;
            return e = this.normalizeGridRange(t), this.computeDateSnapCoverage(t.start) < this.computeDateSnapCoverage(t.end) && (r = vt(e, this)) ? (r.isStart && !this.isValidDate(r.start) && (r.isStart = !1), r.isEnd && r.end && !this.isValidDate(r.end.clone().subtract(1)) && (r.isEnd = !1), [r]) : []
        }, o.prototype.prepareHits = function() {
            return this.buildCoords()
        }, o.prototype.queryHit = function(t, e) {
            var r, o, i, n, s, l, u, a, h, c, p, d;
            return d = this.snapsPerSlot, n = this.slatCoordCache, r = this.containerCoordCache, null != r.getVerticalIndex(e) && (s = n.getHorizontalIndex(t), null != s) ? (a = n.getWidth(s), this.isRTL ? (u = n.getRightOffset(s), i = (u - t) / a, o = Math.floor(i * d), h = s * d + o, p = u - o / d * a, c = p - (o + 1) / d * a) : (l = n.getLeftOffset(s), i = (t - l) / a, o = Math.floor(i * d), h = s * d + o, c = l + o / d * a, p = l + (o + 1) / d * a), {
                snap: h,
                component: this,
                left: c,
                right: p,
            ...
            var e, r;
            return r = this.start.clone(), r.add(Ct(this.snapDuration, this.snapIndexToDiff[t])), e = r.clone().add(this.snapDuration), {
                start: r,
                end: e
            }
            ...
            }), i = this.slotDates, e = r = 0, o = i.length; o > r; e = ++r) t = i[e], this.view.trigger("dayRender", null, t, this.slatEls.eq(e));
            ...
            var t, e, r, o, i, n, s, l, u, a, h, c, p, d, f, g, y, v, m, w, R, S, b, C, E, T, H, _, I, D, x, F, G, M, W, L, B;
            for (g = this.labelInterval, n = this.headerFormats, e = function() {
                var t, e, r;
                for (r = [], t = 0, e = n.length; e > t; t++) i = n[t], r.push([]);
                return r
            }(), y = null, I = null, W = this.slotDates, M = [], p = 0, v = W.length; v > p; p++) {
                for (r = W[p], B = r.week(), c = this.emphasizeWeeks && null !== I && I !== B, x = d = 0, m = n.length; m > d; x = ++d) i = n[x], F = e[x], y = F[F.length - 1], h = n.length > 1 && x < n.length - 1, H = null, h ? (L = r.format(i), o = r.format(), y && y.text === L ? y.colspan += 1 : H = {
                    text: L,
                    dateData: o,
                    colspan: 1
                }) : !y || Rt(st(this.start, r, g)) ? (L = r.format(i), o = r.format(), H = {
                    text: L,
                    dateData: o,
                    colspan: 1
            ...
            for (u = g > this.slotDuration, s = "<table>", s += "<colgroup>", f = 0, w = W.length; w > f; f++) r = W[f], s += "<col/>";
            for (s += "</colgroup>", s += "<tbody>", l = E = 0, R = e.length; R > E; l = ++E) {
                for (F = e[l], a = l === e.length - 1, s += "<tr" + (u && a ? ' class="fc-chrono"' : "") + ">", T = 0, S = F.length; S > T; T++) t = F[T], s += '<th class="' + this.view.widgetHeaderClass + " " + (t.weekStart ? "fc-em-cell" : "") + '" data-date="' + t.dateData + '"' + (t.colspan > 1 ? ' colspan="' + t.colspan + '"' : "") + '><div class="fc-cell-content"><span class="fc-cell-text">' + yt(t.text) + "</span></div></th>";
                s += "</tr>"
            }
            for (s += "</tbody></table>", G = "<table>", G += "<colgroup>", _ = 0, b = M.length; b > _; _++) t = M[_], G += "<col/>";
            for (G += "</colgroup>", G += "<tbody><tr>", l = D = 0, C = M.length; C > D; l = ++D) t = M[l], r = W[l], G += this.slatCellHtml(r, t.weekStart);
            ...
            var r;
            return this.isTimeScale ? (r = [], r.push(Rt(st(this.start, t, this.labelInterval)) ? "fc-major" : "fc-minor")) : (r = this.getDayClasses(t), r.push("fc-day")), r.unshift(this.view.widgetContentClass), e && r.push("fc-em-cell"), '<td class="' + r.join(" ") + '" data-date="' + t.format() + '"><div /></td>'
            ...
            return this.isTimeScale ? J(this.slotDuration) : void 0
        }, o.prototype.renderNowIndicator = function(e) {
            var r, o, i;
            return i = [], e = this.normalizeGridDate(e), e >= this.start && e < this.end && (r = this.dateToCoord(e), o = this.isRTL ? {
                right: -r
            } : {
                left: r
            }, i.push(t("<div class='fc-now-indicator fc-now-indicator-arrow'></div>").css(o).appendTo(this.headScroller.canvas.el)[0]), i.push(t("<div class='fc-now-indicator fc-now-indicator-line'></div>").css(o).appendTo(this.bodyScroller.canvas.el)[0])), this.nowIndicatorEls = t(i)
            ...
            var e, r, o;
            return r = st(this.start, t, this.snapDuration), 0 > r ? 0 : r >= this.snapDiffToIndex.length ? this.snapCnt : (o = Math.floor(r), e = this.snapDiffToIndex[o], Rt(e) ? e += r - o : e = Math.ceil(e), e)
        }, o.prototype.dateToCoord = function(t) {
            var e, r, o, i, n;
            return n = this.computeDateSnapCoverage(t), o = n / this.snapsPerSlot, i = Math.floor(o), i = Math.min(i, this.slotCnt - 1), r = o - i, e = this.slatInnerCoordCache, this.isRTL ? e.getRightPosition(i) - e.getWidth(i) * r - this.containerCoordCache.getWidth(0) : e.getLeftPosition(i) + e.getWidth(i) * r
            ...
            var t;
            return t = this.headScroller.canvas.contentEl.find("table"), t.height.apply(t, arguments)
        }, o.prototype.updateSegPositions = function() {
            var t, e, r, o, i;
            for (i = (this.segs || []).concat(this.businessHourSegs || []), e = 0, r = i.length; r > e; e++) o = i[e], t = this.rangeToCoords(o), o.el.css({
                left: o.left = t.left,
            ...
            return this.headScroller.setScrollLeft(t.left), this.headScroller.setScrollLeft(t.left), this.bodyScroller.setScrollTop(t.top)
            ...
            var e, r, o, i, n, s, l, u, a, h, c, p, d, f, g, y, v, m, w, R, S, b, C, E, T;
            for (o = 0, s = t.length; s > o; o++)
                for (w = t[o], e = w[0], T = w[1], i = 0, l = T.length; l > i; i++) E = T[i], r = this.rangeToCoords(E), E.el.css({
                    left: E.left = r.left,
                    right: -(E.right = r.right)
                });
            for (n = 0, u = t.length; u > n; n++)
                for (R = t[n], e = R[0], T = R[1], f = 0, a = T.length; a > f; f++) E = T[f], E.el.appendTo(e.segContainerEl);
            for (g = 0, h = t.length; h > g; g++) {
                for (S = t[g], e = S[0], T = S[1], y = 0, c = T.length; c > y; y++) E = T[y], E.height = E.el.outerHeight(!0);
                this.buildSegLevels(T), e.segContainerHeight = tt(T)
            }
            for (C = [], v = 0, p = t.length; p > v; v++) {
                for (b = t[v], e = b[0], T = b[1], m = 0, d = T.length; d > m; m++) E = T[m], E.el.css("top", E.top);
                C.push(e.segContainerEl.height(e.segContainerHeight))
            }
            return C
        }, o.prototype.buildSegLevels = function(t) {
            var e, r, o, i, n, s, l, u, a, h, c, p, d, f;
            for (d = [], this.sortEventSegs(t), o = 0, s = t.length; s > o; o++) {
                for (f = t[o], f.above = [], a = 0; a < d.length;) {
                    for (r = !1, c = d[a], i = 0, l = c.length; l > i; i++) h = c[i], Bt(f, h) && (f.above.push(h), r = !0);
                    if (!r) break;
                    a += 1
                }
                for ((d[a] || (d[a] = [])).push(f), a += 1; a < d.length;) {
                    for (p = d[a], n = 0, u = p.length; u > n; n++) e = p[n], Bt(f, e) && e.above.push(f);
                    a += 1
                }
            }
            return d
            ...
            var o, i, n, s, l, u, a, h, c, p, d, f, g, y, v, m, w, R;
            for (s = [], w = [], l = 0, h = e.length; h > l; l++)
                for (g = e[l], o = g[0], R = g[1], u = 0, c = R.length; c > u; u++) m = R[u], i = this.rangeToCoords(m), m.el.css({
                    left: m.left = i.left,
                    right: -(m.right = i.right)
                }), r && r.resourceId === (null != (y = o.resource) ? y.id : void 0) ? m.el.css("top", r.el.css("top")) : m.el.css("top", 0);
            for (a = 0, p = e.length; p > a; a++)
                for (v = e[a], o = v[0], R = v[1], n = t('<div class="fc-event-container fc-helper-container"/>').appendTo(o.innerEl), s.push(n[0]), f = 0, d = R.length; d > f; f++) m = R[f], n.append(m.el), w.push(m.el[0]);
            return this.helperEls = this.helperEls ? this.helperEls.add(t(s)) : t(s), t(w)
            ...
            var o, i, n, s, l, u;
            for (l = [], i = 0, n = e.length; n > i; i++) s = e[i], o = s[0], u = s[1], l.push(this.renderFillInContainer(t, o, u, r));
            return l
        }, o.prototype.renderFillInContainer = function(e, r, o, i) {
            var n, s, l, u, a;
            if (o.length) {
                for (i || (i = e.toLowerCase()), n = t('<div class="fc-' + i + '-container" />').appendTo(r.bgSegContainerEl), l = 0, u = o.length; u > l; l++) a = o[l], s = this.rangeToCoords(a), a.el.css({
                    left: a.left = s.left,
                    right: -(a.right = s.right)
                }), a.el.appendTo(n);
                return this.elsByFill[e] = this.elsByFill[e] ? this.elsByFill[e].add(n) : n
            }
        }, o.prototype.renderDrag = function(t, e) {
            return e ? this.renderEventLocationHelper(t, e) : (this.renderHighlight(this.eventToSpan(t)), null)
        }, o.prototype.unrenderDrag = function() {
            return this.unrenderHelper(), this.unrenderHighlight()
        }, o
    }(f), tt = function(t) {
        var e, r, o, i;
        for (o = 0, e = 0, r = t.length; r > e; e++) i = t[e], o = Math.max(o, Z(i));
        return o
    }, Z = function(t) {
        return null == t.top && (t.top = tt(t.above)), t.top + t.height
    }, Bt = function(t, e) {
        return t.left < e.right && t.right > e.left
    }, S = 18, w = 6, m = 200, R = 1e3, u = {
        months: 1
    }, z = [{
        years: 1
    }, {
        ...
        milliseconds: 1
    }], q.prototype.initScaleProps = function() {
        var e, r, o;
    ...
    }, q.prototype.queryDurationOption = function(t) {
        var r, o;
        return o = this.opt(t), null != o && (r = e.duration(o), +r) ? r : void 0
    }, q.prototype.validateLabelAndSlot = function() {
        var t, e, r;
    ...
    }, q.prototype.ensureGridDuration = function() {
        var t, r, o, i, n;
        if (t = this.duration, !t) {
            if (t = this.view.intervalDuration, !t)
                if (this.labelInterval || this.slotDuration)
                    for (n = this.ensureLabelInterval(), o = z.length - 1; o >= 0 && (r = z[o], t = e.duration(r), i = nt(t, n), !(i >= S)); o += -1);
                else t = e.duration(u);
            this.duration = t
        }
        return t
    }, q.prototype.ensureLabelInterval = function() {
        var t, r, o, i, n, s, l, u, a;
        if (n = this.labelInterval, !n) {
            if (this.duration || this.slotDuration || this.ensureGridDuration(), this.slotDuration) {
                for (r = 0, s = z.length; s > r; r++)
                    if (t = z[r], a = e.duration(t), u = nt(a, this.slotDuration), Rt(u) && w >= u) {
                        n = a;
                        break
                    }
                n || (n = this.slotDuration)
            } else
                for (o = 0, l = z.length; l > o && (t = z[o], n = e.duration(t), i = nt(this.duration, n), !(i >= S)); o++);
            this.labelInterval = n
        }
        return n
    }, q.prototype.ensureSlotDuration = function() {
        var t, r, o, i, n, s, l, u;
        if (s = this.slotDuration, !s) {
            for (o = this.ensureLabelInterval(), r = 0, i = z.length; i > r; r++)
                if (t = z[r], u = e.duration(t), l = nt(o, u), Rt(l) && l > 1 && w >= l) {
                    s = u;
                    break
                }
            s && this.duration && (n = nt(this.duration, s), n > m && (s = null)), s || (s = o), this.slotDuration = s
        }
        return s
    }, q.prototype.computeHeaderFormats = function() {
        var t, e, r, o, i, n, s, l;
        switch (s = this.view, o = this.duration, i = this.labelInterval, n = J(i), l = this.opt("weekNumbers"), t = e = r = null, "week" !== n || l || (n = "day"), n) {
            case "year":
                t = "YYYY";
                break;
            case "month":
            ...
            case "hour":
                ...
                break;
            case "minute":
                i.asMinutes() / 60 >= w ? (t = this.opt("hourFormat"), e = "[:]mm") : t = this.opt("mediumTimeFormat");
                break;
            case "second":
                i.asSeconds() / 60 >= w ? (t = "LT", e = "[:]ss") : t = "LTS";
                break;
            case "millisecond":
                t = "LTS", e = "[.]SSS"
        }
        ...
        return zt(r, e), r.mixin(L), r.prototype.resourceGrid = null, r.prototype.tbodyHash = null, r.prototype.joiner = null, r.prototype.dividerEls = null, r.prototype.superHeaderText = null, r.prototype.isVGrouping = null, r.prototype.isHGrouping = null, r.prototype.groupSpecs = null, r.prototype.colSpecs = null, r.prototype.orderSpecs = null, r.prototype.rowHierarchy = null, r.prototype.resourceRowHash = null, r.prototype.nestingCnt = 0, r.prototype.isNesting = null, r.prototype.dividerWidth = null, r.prototype.initialize = function() {
            ...
            }), w = [], i = [], s = [], h = !1, a = !1, c = 0, g = t.length; g > c; c++) r = t[c], r.group ? i.push(r) : w.push(r);
            for (w[0].isMain = !0, i.length ? (s = i, h = !0) : (l = this.opt("resourceGroupField"), l && (a = !0, s.push({
                field: l,
                text: this.opt("resourceGroupText"),
                render: this.opt("resourceGroupRender")
            }))), e = Dt(this.opt("resourceOrder")), R = [], p = 0, y = e.length; y > p; p++) {
                for (m = e[p], u = !1, d = 0, v = s.length; v > d; d++)
                    if (n = s[d], n.field === m.field) {
                        n.order = m.order, u = !0;
                        break
                    }
                u || R.push(m)
            }
            return this.superHeaderText = S, this.isVGrouping = h, this.isHGrouping = a, this.groupSpecs = s, this.colSpecs = i.concat(w), this.orderSpecs = R
            ...
            var e, r, o, i, n;
            return r = this.opt("isRTL"), i = 30, o = this.el.width() - 30, n = this.getNaturalDividerWidth(), e = new a({
                ...
                drag: function(t) {
                    return function(e, s) {
                        var l;
                        return l = r ? n - e : n + e, l = Math.max(l, i), l = Math.min(l, o), t.dividerWidth = l, t.positionDivider(l), t.updateWidth()
                    }
                }(this),
                dragEnd: function(t) {
                    return function() {
            ...
            var t;
            return this.resourceGrid.headHeight("auto"), this.timeGrid.headHeight("auto"),
                t = Math.max(this.resourceGrid.headHeight(), this.timeGrid.headHeight()), this.resourceGrid.headHeight(t), this.timeGrid.headHeight(t), t
            ...
            var e, r, o, i, n, s;
            for (this.cellFollower && this.cellFollower.clearSprites(), this.cellFollower = new V(this.resourceGrid.bodyScroller, this.calendar.isTouch), this.cellFollower.isHFollowing = !1, this.cellFollower.isVFollowing = !0, i = [], n = this.rowHierarchy.getNodes(), r = 0, o = n.length; o > r; r++) s = n[r], s instanceof U && s.groupTd && (e = s.groupTd.find(".fc-cell-content"), e.length && i.push(e[0]));
            return this.cellFollower.setSprites(t(i))
        }, r.prototype.insertResource = function(t, e) {
            var r, o, i, n, s, l, u;
            for (u = new F(this, t), null == e && (n = t.parentId, n && (e = this.getResourceRow(n))), e ? this.insertRowAsChild(u, e) : this.insertRow(u), s = t.children, l = [], o = 0, i = s.length; i > o; o++) r = s[o], l.push(this.insertResource(r, u));
            return l
        }, r.prototype.insertRow = function(t, e, r) {
            var o;
            return null == e && (e = this.rowHierarchy), null == r && (r = this.groupSpecs), r.length ? (o = this.ensureResourceGroup(t, e, r[0]), o instanceof g ? this.insertRowAsChild(t, o) : this.insertRow(t, o, r.slice(1))) : this.insertRowAsChild(t, e)
            ...
            if (this.orderSpecs.length)
                for (s = e.children, o = i = 0, n = s.length; n > i; o = ++i)
                    if (l = s[o], r = this.compareResources(l.resource || {}, t.resource || {}), r > 0) return o;
            return null
        }, r.prototype.compareResources = function(t, e) {
            return Q(t, e, this.orderSpecs)
        }, r.prototype.ensureResourceGroup = function(t, e, r) {
            var o, i, n, s, l, u, a, h, c, p, d;
            if (n = (t.resource || {})[r.field], i = null, r.order)
                for (c = e.children, s = l = 0, a = c.length; a > l; s = ++l) {
                    if (d = c[s], o = ut(d.groupValue, n) * r.order, 0 === o) {
                        i = d;
                        break
                    }
                    if (o > 0) break
                } else
                for (p = e.children, s = u = 0, h = p.length; h > u; s = ++u)
                    if (d = p[s], d.groupValue === n) {
                        i = d;
                        break
                    }
            return i || (i = this.isVGrouping ? new U(this, r, n) : new g(this, r, n), e.addChild(i, s)), i
        }, r.prototype.pairSegsWithRows = function(t) {
            var e, r, o, i, n, s, l, u;
            for (i = [], n = {}, e = 0, r = t.length; r > e; e++) u = t[e], s = u.resourceId, s && (l = this.getResourceRow(s), l && (o = n[s], o || (o = [l, []], i.push(o), n[s] = o), o[1].push(u)));
            return i
        }, r.prototype.rowAdded = function(t) {
            var e, r;
            return t instanceof F && (this.resourceRowHash[t.resource.id] = t), r = this.isNesting, e = Boolean(this.nestingCnt += t.depth ? 1 : 0), r !== e && (this.el.toggleClass("fc-nested", e), this.el.toggleClass("fc-flat", !e)), this.isNesting = e
        }, r.prototype.rowRemoved = function(t) {
            var e, r;
            return t instanceof F && delete this.resourceRowHash[t.resource.id], r = this.isNesting, e = Boolean(this.nestingCnt -= t.depth ? 1 : 0), r !== e && (this.el.toggleClass("fc-nested", e), this.el.toggleClass("fc-flat", !e)), this.isNesting = e
            ...
            var r, o, i, n, s, l, u, a, h, c;
            for (null == e && (e = !1), null == t && (t = this.getVisibleRows()), l = 0, a = t.length; a > l; l++) c = t[l], c.setTrInnerHeight("");
            for (s = function() {
                var o, i, n;
                for (n = [], o = 0, i = t.length; i > o; o++) c = t[o], r = c.getMaxTrInnerHeight(), e && (r += r % 2), n.push(r);
                return n
            }(), n = u = 0, h = t.length; h > u; n = ++u) c = t[n], c.setTrInnerHeight(s[n]);
            return !e && (o = this.resourceGrid.tbodyEl.height(), i = this.timeGrid.tbodyEl.height(), Math.abs(o - i) > 1) ? this.syncRowHeights(t, !0) : void 0
        }, r.prototype.getVisibleRows = function() {
            var t, e, r, o, i;
            for (r = this.rowHierarchy.getRows(), o = [], t = 0, e = r.length; e > t; t++) i = r[t], i.isShown && o.push(i);
            return o
        }, r.prototype.getEventRows = function() {
            var t, e, r, o, i;
            for (r = this.rowHierarchy.getRows(), o = [], t = 0, e = r.length; e > t; t++) i = r[t], i instanceof p && o.push(i);
            return o
        }, r.prototype.getResourceRow = function(t) {
            return this.resourceRowHash[t]
        }, r.prototype.setScroll = function(t) {
            return r.__super__.setScroll.apply(this, arguments), this.resourceGrid.bodyScroller.setScrollTop(t.top)
        }, r
    }(Y), M = function(e) {
        function r() {
            return r.__super__.constructor.apply(this, arguments)
        }
        return zt(r, e), r.mixin(I), r.prototype.eventRows = null, r.prototype.shownEventRows = null, r.prototype.tbodyEl = null, r.prototype.rowCoordCache = null, r.prototype.spanToSegs = function(t) {
            var e, o, i, n, s, l;
            if (l = r.__super__.spanToSegs.apply(this, arguments), e = this.view.calendar, n = t.resourceId)
                for (o = 0, i = l.length; i > o; o++) s = l[o], s.resource = e.getResourceById(n), s.resourceId = n;
            return l
            ...
            return r.__super__.prepareHits.apply(this, arguments), this.eventRows = this.view.getEventRows(), this.shownEventRows = function() {
                var e, r, o, i;
                for (o = this.eventRows, i = [], e = 0, r = o.length; r > e; e++) t = o[e], t.isShown && i.push(t);
                return i
            }.call(this), e = function() {
                var e, r, o, i;
                for (o = this.shownEventRows, i = [], e = 0, r = o.length; r > e; e++) t = o[e], i.push(t.getTr("event")[0]);
                return i
            ...
            var o, i;
            return i = r.__super__.queryHit.apply(this, arguments), i && (o = this.rowCoordCache.getVerticalIndex(e), null != o) ? {
            ...
            var e;
            return r.__super__.renderSkeleton.apply(this, arguments), this.segContainerEl.remove(), this.segContainerEl = null, e = t('<div class="fc-rows"><table><tbody/></table></div>').appendTo(this.bodyScroller.canvas.contentEl), this.tbodyEl = e.find("tbody")
        }, r.prototype.renderFgSegs = function(t) {
            var e, r, o, i, n, s, l;
            for (t = this.renderFgSegEls(t), s = this.view.pairSegsWithRows(t), l = [], o = 0, i = s.length; i > o; o++) n = s[o], e = n[0], r = n[1], e.fgSegs = r, e.isShown && (e.isSegsRendered = !0, l.push(n));
            ...
            var o, i, n, s, l, u, a, h, c, p, d, f;
            for (e = this.renderFillSegEls(t, e), h = [], l = [], o = 0, n = e.length; n > o; o++) d = e[o], d.resourceId ? h.push(d) : l.push(d);
            for (a = this.view.pairSegsWithRows(h), f = [], i = 0, s = a.length; s > i; i++) u = a[i], c = u[0], p = u[1], "bgEvent" === t && (c.bgSegs = p), c.isShown && f.push(u);
            ...
            var t, e, o, i, n, s, l, u;
            for (u = r.__super__.queryScroll.apply(this, arguments), l = this.bodyScroller.scrollEl.offset().top, n = this.view.getVisibleRows(), o = 0, i = n.length; i > o; o++)
                if (s = n[o], s.resource && (t = s.getTr("event"), e = t.offset().top + t.outerHeight(), e > l)) {
            ...
            var e, o, i, n;
            return t.resourceId && (n = this.view.getResourceRow(t.resourceId), n && (e = n.getTr("event"), e && (i = this.bodyScroller.canvas.el.offset().top, o = e.offset().top + e.outerHeight(), t.top = o - t.bottom - i))), r.__super__.setScroll.call(this, t)
        }, r.prototype.scrollToResource = function(t) {
            var e, r, o, i;
            return o = this.view.getResourceRow(t.id), o && (e = o.getTr("event")) ? (r = this.bodyScroller.canvas.el.offset().top, i = e.offset().top - r, this.bodyScroller.scrollEl.scrollTop(i)) : void 0
        }, r
    }(q), r = 30, N = function() {
        function e(t) {
            var e;
            this.view = t, this.isRTL = this.view.opt("isRTL"), this.givenColWidths = this.colWidths = function() {
                var t, r, o, i;
                for (o = this.view.colSpecs, i = [], t = 0, r = o.length; r > t; t++) e = o[t], i.push(e.width);
                return i
            }.call(this)
        }
        return e.prototype.view = null, e.prototype.headEl = null, e.prototype.el = null, e.prototype.tbodyEl = null, e.prototype.headScroller = null, e.prototype.bodyScroller = null, e.prototype.joiner = null, e.prototype.colGroupHtml = "", e.prototype.headTable = null, e.prototype.headColEls = null, e.prototype.headCellEls = null, e.prototype.bodyColEls = null, e.prototype.bodyTable = null, e.prototype.renderSkeleton = function() {
            return this.headScroller = new s({
                overflowX: "clipped-scroll",
                overflowY: "hidden"
            }), this.headScroller.canvas = new O, this.headScroller.render(), this.headScroller.canvas.contentEl.html(this.renderHeadHtml()), this.headEl.append(this.headScroller.el), this.bodyScroller = new s({
                overflowY: "clipped-scroll"
            }), this.bodyScroller.canvas = new O, this.bodyScroller.render(), this.bodyScroller.canvas.contentEl.html("<table>" + this.colGroupHtml + "<tbody/></table>"), this.tbodyEl = this.bodyScroller.canvas.contentEl.find("tbody"), this.el.append(this.bodyScroller.el), this.joiner = new A("horizontal", [this.headScroller, this.bodyScroller]), this.headTable = this.headEl.find("table"), this.headColEls = this.headEl.find("col"), this.headCellEls = this.headScroller.canvas.contentEl.find("tr:last-child th"), this.bodyColEls = this.el.find("col"), this.bodyTable = this.el.find("table"), this.colMinWidths = this.computeColMinWidths(), this.applyColWidths(), this.initColResizing()
        }, e.prototype.renderHeadHtml = function() {
            var t, e, r, o, i, n, s, l, u, a, h;
            for (e = this.view.colSpecs, r = "<table>", t = "<colgroup>", s = 0, u = e.length; u > s; s++) h = e[s], t += h.isMain ? '<col class="fc-main-col"/>' : "<col/>";
            for (t += "</colgroup>", this.colGroupHtml = t, r += t, r += "<tbody>", this.view.superHeaderText && (r += '<tr class="fc-super"><th class="' + this.view.widgetHeaderClass + '" colspan="' + e.length + '"><div class="fc-cell-content"><span class="fc-cell-text">' + yt(this.view.superHeaderText) + "</span></div></th></tr>"), r += "<tr>", n = !0, o = l = 0, a = e.length; a > l; o = ++l) h = e[o], i = o === e.length - 1, r += '<th class="' + this.view.widgetHeaderClass + '"><div><div class="fc-cell-content">' + (h.isMain ? '<span class="fc-expander-space"><span class="fc-icon"></span></span>' : "") + '<span class="fc-cell-text">' + yt(h.labelText || "") + "</span></div>" + (i ? "" : '<div class="fc-col-resizer"></div>') + "</div></th>";
            ...
            var i, n, s, l;
            return i = this.colWidths = this.queryColWidths(), i.pop(), i.push(null), l = i[t], s = Math.min(this.colMinWidths[t], r), n = new a({
                dragStart: function(t) {
                    return function() {
                ...
                drag: function(e) {
                    return function(r, o) {
                        var n;
                        return n = l + (e.isRTL ? -r : r), n = Math.max(n, s), i[t] = n, e.applyColWidths()
                    }
                }(this),
                dragEnd: function(t) {
                    return function() {
            ...
            var t, e, r, o, i, n, s, l, u, a, h, c, p, d, f, g, y;
            for (r = this.colMinWidths, i = this.colWidths, t = !0, e = !1, y = 0, a = 0, p = i.length; p > a; a++) o = i[a], "number" == typeof o ? y += o : (t = !1, o && (e = !0));
            for (l = e && !this.view.isHGrouping ? "auto" : "", s = function() {
                var t, e, r;
                for (r = [], u = t = 0, e = i.length; e > t; u = ++t) o = i[u], r.push(null != o ? o : l);
                return r
            }(), g = 0, u = h = 0, d = s.length; d > h; u = ++h) n = s[u], g += "number" == typeof n ? n : r[u];
            for (u = c = 0, f = s.length; f > c; u = ++c) n = s[u], this.headColEls.eq(u).width(n), this.bodyColEls.eq(u).width(n);
            return this.headScroller.canvas.setMinWidth(g), this.bodyScroller.canvas.setMinWidth(g), this.tableMinWidth = g, this.tableWidth = t ? y : void 0
        }, e.prototype.computeColMinWidths = function() {
            var t, e, o, i, n, s;
            for (i = this.givenColWidths, n = [], t = e = 0, o = i.length; o > e; t = ++e) s = i[t], n.push("number" == typeof s ? s : parseInt(this.headColEls.eq(t).css("min-width")) || r);
            return n
        }, e.prototype.queryColWidths = function() {
            var e, r, o, i, n;
            for (i = this.headCellEls, n = [], e = 0, r = i.length; r > e; e++) o = i[e], n.push(t(o).outerWidth());
            return n
        }, e.prototype.updateWidth = function() {
            return this.headScroller.updateSize(), this.bodyScroller.updateSize(), this.joiner.update(), this.follower ? this.follower.update() : void 0
        ...
        return e.prototype.view = null, e.prototype.parent = null, e.prototype.prevSibling = null, e.prototype.children = null, e.prototype.depth = 0, e.prototype.hasOwnRow = !1, e.prototype.trHash = null, e.prototype.trs = null, e.prototype.isRendered = !1, e.prototype.isExpanded = !0, e.prototype.isShown = !1, e.prototype.addChild = function(t, e) {
            var r, o, i, n, s;
            for (t.remove(), r = this.children, null != e ? r.splice(e, 0, t) : (e = r.length, r.push(t)), t.prevSibling = e > 0 ? r[e - 1] : null, e < r.length - 1 && (r[e + 1].prevSibling = t), t.parent = this, t.depth = this.depth + (this.hasOwnRow ? 1 : 0), s = t.getNodes(), o = 0, i = s.length; i > o; o++) n = s[o], n.added();
            return this.isShown && this.isExpanded ? t.show() : void 0
        }, e.prototype.removeChild = function(t) {
            var e, r, o, i, n, s, l, u, a, h;
            for (e = this.children, o = !1, r = i = 0, s = e.length; s > i; r = ++i)
                if (h = e[r], h === t) {
                    o = !0;
                    break
                }
            if (o) {
                for (r < e.length - 1 && (e[r + 1].prevSibling = t.prevSibling), e.splice(r, 1), t.recursivelyUnrender(), u = t.getNodes(), n = 0, l = u.length; l > n; n++) a = u[n], a.removed();
                return t.parent = null, t.prevSibling = null, t
            }
            return !1
        }, e.prototype.removeChildren = function() {
            var t, e, r, o, i, n, s;
            for (n = this.children, e = 0, o = n.length; o > e; e++) t = n[e], t.recursivelyUnrender();
            for (s = this.getDescendants(), r = 0, i = s.length; i > r; r++) t = s[r], t.removed();
            ...
            var e, r, o, i;
            for (null == t && (t = []), this.hasOwnRow && t.push(this), i = this.children, r = 0, o = i.length; o > r; r++) e = i[r], e.getRows(t);
            return t
        }, e.prototype.getNodes = function(t) {
            var e, r, o, i;
            for (null == t && (t = []), t.push(this), i = this.children, r = 0, o = i.length; o > r; r++) e = i[r], e.getNodes(t);
            return t
        }, e.prototype.getDescendants = function() {
            var t, e, r, o, i;
            for (t = [], i = this.children, r = 0, o = i.length; o > r; r++) e = i[r], e.getNodes(t);
            return t
        }, e.prototype.render = function() {
            var e, r, o, i, n, s, l;
            if (this.trHash = {}, s = [], this.hasOwnRow) {
                e = this.getPrevRow(), r = this.view.tbodyHash;
                for (l in r) i = r[l], n = t("<tr/>"), this.trHash[l] = n, s.push(n[0]), o = "render" + K(l) + "Content", this[o] && this[o](n), e ? e.trHash[l].after(n) : i.prepend(n)
            }
            return this.trs = t(s).on("click", ".fc-expander", Ft(this, "toggleExpanded")), this.isRendered = !0
        }, e.prototype.unrender = function() {
            var e, r, o, i;
            if (this.isRendered) {
                e = this.trHash;
                for (o in e) r = e[o], i = "unrender" + K(o) + "Content", this[i] && this[i](r);
            ...
            var t, e, r, o, i;
            for (this.unrender(), o = this.children, i = [], e = 0, r = o.length; r > e; e++) t = o[e], i.push(t.recursivelyUnrender());
            return i
            ...
            if (!this.isShown && (this.isRendered ? this.trs.css("display", "") : this.render(), this.ensureSegsRendered && this.ensureSegsRendered(), this.isExpanded ? this.indicateExpanded() : this.indicateCollapsed(), this.isShown = !0, this.shown(), this.isExpanded)) {
                for (o = this.children, i = [], e = 0, r = o.length; r > e; e++) t = o[e], i.push(t.show());
                return i
            }
        }, e.prototype.hide = function() {
            var t, e, r, o, i;
            if (this.isShown && (this.isRendered && this.trs.hide(), this.isShown = !1, this.hidden(), this.isExpanded)) {
                for (o = this.children, i = [], e = 0, r = o.length; r > e; e++) t = o[e], i.push(t.hide());
                return i
            }
            ...
            return e = 0, t.each(this.trHash, function(t) {
                return function(t, r) {
                    var o;
                    return o = ct(r).find("> div:not(.fc-cell-content):first"), e = Math.max(o.height(), e)
                }
            }(this)), e
        }, e.prototype.setTrInnerHeight = function(e) {
            return t.each(this.trHash, function(t) {
                return function(t, r) {
                    return ct(r).find("> div:not(.fc-cell-content):first").height(e)
                }
            }(this))
        ...
        return zt(r, e), r.prototype.groupSpec = null, r.prototype.groupValue = null, r.prototype.rowRemoved = function(t) {
        ...
        return zt(r, e), r.prototype.hasOwnRow = !0, r.prototype.renderSpreadsheetContent = function(e) {
            var r;
            return r = this.renderGroupContentEl(), r.prepend('<span class="fc-expander"><span class="fc-icon"></span></span>'), t('<td class="fc-divider" />').attr("colspan", this.view.colSpecs.length).append(t("<div/>").append(r)).appendTo(e)
        ...
        return zt(r, e), r.prototype.rowspan = 0, r.prototype.leadingTr = null, r.prototype.groupTd = null, r.prototype.rowShown = function(t) {
        ...
        return zt(e, t), e.prototype.hasOwnRow = !0, e.prototype.segContainerEl = null, e.prototype.segContainerHeight = null, e.prototype.innerEl = null, e.prototype.bgSegContainerEl = null, e.prototype.isSegsRendered = !1, e.prototype.bgSegs = null, e.prototype.fgSegs = null, e.prototype.renderEventContent = function(t) {
        ...
        return zt(r, e), r.prototype.resource = null, r.prototype.rowAdded = function(t) {
            ...
            var r, o, i, n, s, l, u, a, h;
            for (u = this.resource, l = this.view.colSpecs, n = 0, s = l.length; s > n; n++) r = l[n], r.group || (i = r.field ? u[r.field] || null : u, h = "function" == typeof r.text ? r.text(u, i) : i, o = t('<div class="fc-cell-content">' + (r.isMain ? this.renderGutterHtml() : "") + '<span class="fc-cell-text">' + (h ? yt(h) : "&nbsp;") + "</span></div>"), "function" == typeof r.render && (o = r.render(u, o, i) || o), a = t('<td class="' + this.view.widgetContentClass + '"/>').append(o), r.isMain && a.wrapInner("<div/>"), e.append(a));
            ...
            return t += '<span class="fc-expander-space"><span class="fc-icon"></span></span>'
        }, r
    }(p), d.views.timeline.resourceClass = W, E = function(t) {
        function e() {
            return e.__super__.constructor.apply(this, arguments)
        }
        return zt(e, t), e.mixin(L), e.prototype.timeGridClass = G, e.prototype.dayGridClass = H, e.prototype.renderHead = function() {
    ...
    }(d.AgendaView), d.views.agenda.queryResourceClass = function(t) {
        var e;
        return (null != (e = t.options.groupByResource || t.options.groupByDateAndResource) ? e : 1 === t.duration.as("days")) ? E : void 0
    }, T = function(t) {
        function e() {
            return e.__super__.constructor.apply(this, arguments)
        }
        return zt(e, t), e.mixin(L), e.prototype.dayGridClass = H, e.prototype.renderHead = function() {
    ...
    }(d.MonthView), d.views.basic.queryResourceClass = function(t) {
        var e;
        return (null != (e = t.options.groupByResource || t.options.groupByDateAndResource) ? e : 1 === t.duration.as("days")) ? T : void 0
    }, d.views.month.queryResourceClass = function(t) {
        return t.options.groupByResource || t.options.groupByDateAndResource ? x : void 0
    }, C = "2016-04-23", j = {
        years: 1,
        weeks: 1
    }, y = "http://fullcalendar.io/scheduler/license/", b = ["GPL-My-Project-Is-Open-Source", "CC-Attribution-NonCommercial-NoDerivatives"], xt = function(t, e) {
        // return wt(window.location.href) || St(t) || it(e) ? void 0 : Gt('Please use a valid license key. <a href="' + y + '">More Info</a>', e)
    }, St = function(r) {
        var o, i, n, s;
        return -1 !== t.inArray(r, b) ? !0 : (i = (r || "").match(/^(\d+)\-fcs\-(\d+)$/), i && 10 === i[1].length && (n = e.utc(1e3 * parseInt(i[2])), s = e.utc(d.mockSchedulerReleaseDate || C), s.isValid() && (o = s.clone().subtract(j), n.isAfter(o))) ? !0 : !1)
    }, wt = function(t) {
