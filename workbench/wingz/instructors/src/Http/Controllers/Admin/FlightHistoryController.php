...
use Wingz\Instructors\Http\Presenters\FlightHistoryPresenter as Presenter;
...
//        $this->presenter->actions($table);
        ...
        set_meta('search-title', 'Search Flight:');
        return view('wingz/instructors::admin.flight-history', compact('eloquent', 'table'));
    }
