...
use Wingz\Renters\Model\Airport;
...
class RentersPresenter extends Presenter
{
    /**
    ...
    {
        return $this->table->of('wingz.renters', function (TableGrid $table) use ($model) {
...
//            $table->searchable(['company_name']);
    ...
    public function form($model)
    {
        ...
        $form = $this->form->of('wingz.renters', function (FormGrid $form) use ($model) {
