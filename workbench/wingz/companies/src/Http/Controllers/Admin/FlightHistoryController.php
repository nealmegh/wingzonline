...
use Wingz\Companies\Http\Presenters\FlightHistoryPresenter as Presenter;
...
//        $this->presenter->actions($table);
        ...
        set_meta('search::title', 'Flight History');


        return view('wingz/companies::admin.flight-history', compact('eloquent', 'table'));
    }
