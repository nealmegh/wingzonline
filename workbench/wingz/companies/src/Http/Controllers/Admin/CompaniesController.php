...
use Wingz\Companies\Http\Presenters\CompaniesPresenter as Presenter;
use Wingz\Companies\Http\Requests\CompaniesRequest;
...
//        $this->presenter->actions($table);
        ...
        return view('wingz/companies::admin.table', compact('eloquent', 'table'));
    }
